...
@Inject constructor(private val getTrendingReposUseCase: GetTrendingReposUseCase,
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(TrendingsActivityViewModel::class.java)) {
            ...
            return TrendingsActivityViewModel(getTrendingReposUseCase,mainThreadScheduler) as T
        }
